...
router.post("/", authMiddleware, roleMiddleware ("admin"), mahasiswaController.createMahasiswa); //upload.single("foto"),
...
router.put("/:id", authMiddleware, roleMiddleware ("admin"), mahasiswaController.updateMahasiswa); //upload.single("foto"),
